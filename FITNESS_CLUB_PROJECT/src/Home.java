...
public class Home extends JFrame {
    ...
    public Home() {
        ...
        JButton Button6 = new JButton("LOGIN/SIGN UP");
        Button6.setBounds(1301, 66, 210, 37);
        ...
        txtrGetInThe.setFont(new Font("Times New Roman", Font.BOLD, 40));
        txtrGetInThe.setLineWrap(true);
        txtrGetInThe.setText("GET IN\r\nTHE BEST\r\nSHAPE\r\nOF YOUR\r\nLIFE");
        txtrGetInThe.setBounds(71, 205, 215, 251);
